<div class="card-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <x-adminlte-select2 name="cinema_id" id="cinema_id" required
                                :config="['disabled'=> isset($booking) ? true : false]">
                <x-adminlte-options :options="$cinemas"
                                    :selected="(isset($booking)? $booking->screen->cinema_id : old('cinema_id'))"
        ...
        <div class="col-sm-10">
            <x-adminlte-select2 name="screen_id" id="screen_id" required
                ...
                <x-adminlte-options :options="(isset($screens) ? $screens : '' )"
                                    :selected="(isset($booking) ? $booking->screen_id : old('screen_id'))"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <x-adminlte-select2 name="movie_id" id="movie_id" required
                                :config="['disabled'=> isset($booking) ? true : false]">
                <x-adminlte-options :options="$movies" :selected="(isset($booking)? $booking->movie_id : old('movie_id'))"
    ...
    <div class="form-group row">
        <label for="screen_id" class="col-sm-2 col-form-label">Shows</label>
        <div class="col-sm-10">
            <x-adminlte-select2 name="screen_id" id="screen_id" required
                                :config="['disabled'=> isset($booking) ? true : false]">
                <x-adminlte-options :options="(isset($screens) ? $screens : '' )"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control @error('duration') is-invalid @enderror" id="duration"
                   name="duration" value="{{ ( isset($booking) ? $booking->movie->duration : "") }}"
                   placeholder="Enter Duration" disabled required data-rule-maxlength='4'>
            @error('duration')
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control @error('release_at') is-invalid @enderror" id="release_at"
                   name="release_at" value="{{ ( isset($booking) ? $booking->movie->release_at : "") }}"
                   placeholder="Enter Release Date" disabled required data-rule-maxlength='4'>
            @error('release_at')
            <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="number" class="form-control @error('price') is-invalid @enderror" id="price" name="price"
                   placeholder="Enter Price" value="{{ old('price', isset($booking) ? $booking->price : "") }}" required
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <div class="input-group date" id="start_at" data-target-input="nearest">
                <input type="text" class="form-control datetimepicker-input" id="start_at" name="start_at"
                       {{ isset($show) ? 'disabled' : '' }} data-target="#start_at"
        ...
        <div class="col-sm-10">
            <div class="input-group date" id="end_at" data-target-input="nearest">
                <input type="text" class="form-control datetimepicker-input" id="end_at" name="end_at"
                       {{ isset($booking) ? 'disabled' : '' }} data-target="#end_at" placeholder="Enter End Date and Time"
