    ...
    $(document).ready(function() {
        table = $('#table1').dataTable({
            ...
            columns: [{
                ...
                {
                    data: function(row) {
                        return '<a class="btn btn-xs btn-default text-primary mx-1 shadow" title="Edit" href="cities/' + row.id + '/edit" value="' + row.id + '"> ' + '<i class="fa fa-lg fa-fw fa-pen"></i>' + '</a>' +
