            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('operatorUsers.index') }}">Home</a></li>
    ...
    $(document).ready(function() {
        table = $('#table1').dataTable({
            ...
            columns: [{
                ...
                {
                    data: function(row) {
                        return '<a class="btn btn-xs btn-default text-primary mx-1 shadow" title="Edit" href="operatorUsers/' + row.id + '/edit" value="' + row.id + '"> ' + '<i class="fa fa-lg fa-fw fa-pen"></i>' + '</a>' +
