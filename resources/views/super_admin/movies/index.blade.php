                    ...
                    <div class="card">
                        <div class="card-body">
                            <div style="padding-bottom:20px;float:right">
                                <a class="btn btn-sm btn-secondary mx-2 " href="{{ route('movies.create') }}">Add Movie</a>
                            </div>
    ...
    $(document).ready(function() {
        table = $('#table1').dataTable({
            ...
            columns: [{
                ...
                {
                    data: function(row) {
                        return '<a class="btn btn-xs btn-default text-primary mx-1 shadow" title="Edit" href="movies/' + row.id + '/edit" value="' + row.id + '"> ' + '<i class="fa fa-lg fa-fw fa-pen"></i>' + '</a>' +
