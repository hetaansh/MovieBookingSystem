...
@section('content')
<form action="{{ route('admin.operatorUsers.add') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="card-body">
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="operator" id="operator" placeholder="Enter Operator" required>
        </div>
